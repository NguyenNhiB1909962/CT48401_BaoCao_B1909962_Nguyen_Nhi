...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void initState() {
    _imageUrlFocusNode.addListener(() {
      if (!_imageUrlFocusNode.hasFocus) {
        ...
        // Ảnh hợp lệ -> Vẽ lại màn hình để hiển preview
        setState(() {});
      }
    });
  ...
  TextFormField buildPriceField() {
    return TextFormField(
      ...
      validator: (value) {
        if (value!.isEmpty) {
          return 'Vui lòng nhập vào giá sản phẩm.';
        }
        if (double.tryParse(value) == null) {
          return 'Vui lòng nhập giá sản phẩm là số.';
        }
  ...
  TextFormField buildDescriptionField() {
    return TextFormField(
      ...
      validator: (value) {
        ...
        if (value.length < 10) {
          return 'Mô tả sản phẩm phải lớn hơn 10 ký tự.';
        }
        return null;
      },
      onSaved: (value) {
    ...
    return TextFormField(
      ...
      validator: (value) {
        ...
        if (!_isValidImageUrl(value)) {
          return 'Vui lòng nhập vào một địa chỉ hình ảnh có giá trị.';
        }
        return null;
      },
      onSaved: (value) {
